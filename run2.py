...
class WallpaperDownloader(object):
    ...
    def get_tags(self):
        print('='*30)
        print('wallpaperscraft.com 壁纸下载器')
        print('='*30)
        print('正在获取壁纸标签：')
    ...
    def down(self, name, link):
        ...
        self.show(self.count, self.total, run_time)
    ...
    def main(self):
        ...
        self.count = 0
        self.total = 15*sum_page
        print('正在创建下载线程：')
        for index in range(start_page, end_page+1):
            future = tp.submit(self.crawl_page, index)
